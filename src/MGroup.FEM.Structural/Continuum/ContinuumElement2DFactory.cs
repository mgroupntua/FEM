...
namespace MGroup.FEM.Structural.Continuum
{
	...
	public class ContinuumElement2DFactory
	{
		...
		public ContinuumElement2DFactory(double commonThickness, IContinuumMaterial2D commonMaterial,
			ITransientAnalysisProperties commonDynamicProperties)
		{
		...
		public ContinuumElement2D CreateElement(CellType cellType, IReadOnlyList<INode> nodes)
		{
			return CreateElement(cellType, nodes, commonThickness, commonMaterial, commonDynamicProperties);
		}

		public ContinuumElement2D CreateElement(CellType cellType, IReadOnlyList<INode> nodes, double thickness,
			IContinuumMaterial2D material, ITransientAnalysisProperties dynamicProperties)
		{
