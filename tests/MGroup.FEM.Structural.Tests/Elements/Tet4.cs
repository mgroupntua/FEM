...
{
	using FEM.Structural.Continuum;
	using Constitutive.Structural.Continuum;
	using Constitutive.Structural.Transient;
	...
	public class Tet4
	{
		private static readonly IContinuumMaterial3D Material0 = new ElasticMaterial3D(480, 1d / 3d);

		private static readonly TransientAnalysisProperties DynamicMaterial0 = new TransientAnalysisProperties(1, 0, 0);
