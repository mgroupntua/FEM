...
namespace MGroup.FEM.Helpers
{
	...
	{
		static readonly int[] hexa8AdinaNodeForMsolveNodeTade = new int[] { 6, 7, 4, 5, 2, 3, 0, 1 };
		static readonly int[] tet10AdinaNodeForMsolveNodeTade = new int[] { 2, 1, 3, 0, 5, 7, 8, 6, 9, 4 };
