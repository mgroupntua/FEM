...
namespace MGroup.FEM.Thermal.Isoparametric
{
	public class ThermalElement3DFactory
	{
		...
		private readonly IThermalProperties commonMaterial;
		...
		public ThermalElement3DFactory(IThermalProperties commonMaterial)
		{
			this.commonMaterial = commonMaterial;
		}

		public ThermalElement3D CreateElement(CellType cellType, IReadOnlyList<INode> nodes)
		{
