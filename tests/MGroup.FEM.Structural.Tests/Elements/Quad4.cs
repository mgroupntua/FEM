...
namespace MGroup.FEM.Structural.Tests.Elements
{
	...
	public class Quad4
	{
		...
		private static readonly ElasticMaterial2D material1 = new ElasticMaterial2D(2e6, 0.3, StressState2D.PlaneStress);
		private static readonly ElasticMaterial2D material2 = new ElasticMaterial2D(1d, 0.25, StressState2D.PlaneStress);
